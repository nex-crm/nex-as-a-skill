...
// NewChannelManager creates a manager that persists to ~/.nex-cli/chat/channels.json.
func NewChannelManager() (*ChannelManager, error) {
	home, err := os.UserHomeDir()
	if err != nil {
		return nil, fmt.Errorf("get home dir: %w", err)
	}
	return NewChannelManagerAt(filepath.Join(home, ".nex-cli", "chat", "channels.json"))
}
