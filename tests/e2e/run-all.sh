...
cleanup() {
  pkill -f "termwright.*nex-go-e2e" 2>/dev/null || true
  rm -f "$SOCKET"
  sleep 1
}
...
echo "=== Nex CLI E2E Acceptance Tests ==="
echo "Binary: $NEX"
