...
Termwright E2E:
- Boot nex → verify roster shows all 7 agents
...
- [ ] `go test ./...` — all pass
- [ ] `go build -o nex ./cmd/nex` — clean build
- [ ] `./nex --version` — prints version
- [ ] Manual test: launch `./nex`, see CEO terminal, type message, see response
